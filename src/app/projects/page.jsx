...
export default function ProjectsPage() {
  return (
    <>
      ...
      {/* <SectionBreak /> */}
      <div className="grid grid-flow-row divide-x grid-cols-[1fr_2fr_repeat(3,_1fr)] w-screen grid-rows-[6fr_1fr_3fr] h-[calc(100vh-7rem)] border-b">
        ...
        <div className="row-span-1 order-6 col-span-2 flex items-center">
          <Link href="/">
            <p className="text-4xl font-light pl-4 after:content-['_↗'] after:text-6xl ">This Website </p>
          </Link>
        </div>
      ...
      <SectionBreak />
      <div className="grid grid-flow-row divide-x grid-cols-[repeat(3,_1fr)_2fr_1fr] w-screen grid-rows-[6fr_1fr_3fr] h-[calc(100vh-7rem)] border-b">
        ...
        <div className="row-span-1 order-5 col-span-2 flex items-center border-r ">
          <Link href="/">
            <p className="text-4xl font-light pl-4 after:content-['_↗'] after:text-6xl">Basic Blog</p>
          </Link>
        </div>
        <div className="row-span-1 order-7 col-span-3 border-t">
          <div className="p-10">
      ...
      <div className="grid grid-flow-row divide-x grid-cols-[1fr_2fr_repeat(3,_1fr)] w-screen grid-rows-[6fr_1fr_3fr] h-[calc(100vh-7rem)] border-b">
        ...
        <div className="row-span-1 order-6 col-span-2 flex items-center">
          <Link href="/">
            <p className="text-4xl font-light pl-4">Forms</p>
          </Link>
        </div>
        <div className="row-span-1 order-7 col-span-3 border-t">
          <div className="p-10">
